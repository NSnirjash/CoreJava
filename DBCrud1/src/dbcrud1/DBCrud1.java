...
public class DBCrud1 {
    ...
    public static void main(String[] args) {
        ...
        updateData("Razu", "razu@gmail.com", "panthapath", "12344567890", 2);
    ...
    public static void saveData(String name, String email, String address, String cell_no) {
        ...
        try {
            ...
            Logger.getLogger(DBCrud1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void showData() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                System.out.println("Student Id: " + stu_id + "\tName; " + name + "\tEmail: " + email + "\tAddress: " + address + "\tContact: " + cell_no);
            }
